...
const CheckoutPage = () => {
  ...
  useEffect(() => {
    ...
    // Simple summary derived from order; robust to missing fields
    ...
    // Simulated flow (when Stripe keys/intent are missing)
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={5}>
            ...
            >
              ...
              <CardContent>
                <Stack spacing={1.25}>
                  {(summary.items.length ? summary.items : [{ name: "Your items", quantity: 1, price: summary.subtotal }]).map(
                      (it, idx) => (
                          <Stack
                              key={idx}
                              direction="row"
                          ...
                          >
                            ...
                            <Typography variant="body2">
                              {summary.currency}{(it.price ?? 0 * (it.quantity ?? 1)).toFixed?.(2) ?? it.price}
                            </Typography>
                          </Stack>
                      )
                  )}
